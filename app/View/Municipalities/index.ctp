<div class="municipalities index">
	...
	<tr>
		...
		<td><?php echo h($municipality['Municipality']['title']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $municipality['Municipality']['id']), array(), __('Are you sure you want to delete # %s?', $municipality['Municipality']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
